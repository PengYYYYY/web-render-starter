...
export interface ICanvasKit {
   ...
   * @param device
   */
  MakeGPUDeviceContext(device: any): WebGPUDeviceContext | null;
   ...
   */
  MakeLazyImageFromTextureSource(src: TextureSource, info?: ImageInfo | PartialImageInfo, srcIsPremul?: boolean): Image;
...
export interface Canvas extends EmbindObject<Canvas> {
   ...
   * @param paint
   */
  drawImageRectCubic(img: Image, src: InputRect, dest: InputRect, B: number, C: number, paint?: Paint | null): void;
...
export interface RuntimeEffect extends EmbindObject<RuntimeEffect> {
   ...
   * @param localMatrix
   */
  makeShader(uniforms: Float32Array | number[] | MallocObj, localMatrix?: InputMatrix): Shader;
...
export interface ImageFilterFactory {
   ...
   */
  MakeBlend(blend: BlendMode, background: ImageFilter | null, foreground: ImageFilter | null): ImageFilter;
